...
Проверка на плате: firmwareVersion 0.2.1-mock в серверном логе, не менее трёх последовательных HTTP 202 без task_wdt. Сборка сама по себе этого не подтверждает.
